...
import { AuthApi, DiskonApi, MitraApi, MotorApi, MotorImageApi, NotifikasiApi, PelangganApi, PenggunaApi, ReactApi, SetoranAPINETApi, StorageApi, TransaksiApi } from './apis';
